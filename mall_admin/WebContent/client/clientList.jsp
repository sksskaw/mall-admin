...
<%@page import="gdu.mall.dao.ClientDao"%>
<%
	// 세션 검사
                                ...
                                <div class="table-responsive">
									...
									<table id="zero_config" class="table table-striped table-bordered">
											<tr>
												...
												<th><span style="font-weight:bold">clientDate</span></th>
												<th><span style="font-weight:bold">수정</span></th>
										...
										<tbody>
											...
											%>
												<tr>
													...
													<td><a href="<%=request.getContextPath()%>/client/updateClientForm.jsp?clientNo=<%=c.getClientNo()%>"><button type="button" class="btn btn-warning btn-sm">수정</button></a></td>
													<td><a href="<%=request.getContextPath()%>/client/deleteClientAction.jsp?clientNo=<%=c.getClientNo()%>"><button type="button" class="btn btn-danger btn-sm">삭제</button></a></td>
												</tr>
											<%		
												}
											%>
									...
									<%
										...
										if(currentPage != 1){
									%>
											<a href="<%=request.getContextPath()%>/client/clientList.jsp?currentPage=<%=currentPage-1%>&rowPerPage=<%=rowPerPage%>&searchWord=<%=searchWord%>"><button type="button" class="btn btn-outline-secondary">Previous</button></a>
									<%
										}
									%>
									<%
										//마지막 페이지에는 > 버튼이 보이지 않게
										if(currentPage < (ClientDao.totalCount(searchWord)/rowPerPage) + 1){ //나머지 부분도 출력하기 위한 +1
									%>
											<a href="<%=request.getContextPath()%>/client/clientList.jsp?currentPage=<%=currentPage+1%>&rowPerPage=<%=rowPerPage%>&searchWord=<%=searchWord%>"><button type="button" class="btn btn-outline-secondary">Next</button></a>
									<%
										}
									%>
									<!-- 고객 메일 검색 폼 -->
