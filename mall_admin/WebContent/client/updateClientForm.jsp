...
<%
	...
	// DB에서 해당 고객 정보 가져오기
	Client client = ClientDao.selectClientOne(clientNo);
%>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                        	<form class="form-horizontal" action="<%=request.getContextPath()%>/client/updateClientAction.jsp" method="post">
                            <div class="card-body">
                                    <h4 class="card-title">Update Client</h4>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">clientNo : </label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="fname" name="clientNo" value="<%=client.getClientNo()%>" readonly="readonly">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">clientMail : </label>
                                        <div class="col-sm-9">
                                            <input type="email" class="form-control" id="lname" placeholder="clientMail Here" name="clientMail" value="<%=client.getClientMail()%>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">clientPw :  </label>
                                        <div class="col-sm-9">
                                            <input type="password" class="form-control" id="lname" placeholder="Password Here" name="clientPw" value="">
                                        </div>
                                    </div>
                                </div>
