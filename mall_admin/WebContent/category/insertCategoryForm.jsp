        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <form class="form-horizontal" action="<%=request.getContextPath()%>/category/insertCategoryAction.jsp" method="post">
                            <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="fname" placeholder="categoryName" name="categoryName">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">categoryWeight : </label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="lname" name="categoryWeight" readonly="readonly" value="0">
                                        </div>
                                    </div>
                                </div>
