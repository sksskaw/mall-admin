            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Category Datatable</h5>
                                <div class="table-responsive">
                                	<a href="<%=request.getContextPath()%>/category/insertCategoryForm.jsp"><button type="button" class="btn btn-success btn-sm">카테고리 추가</button></a>
									<table id="zero_config" class="table table-striped table-bordered">
										<tr>
											<th><span style="font-weight:bold">categoryName</span></th>
											<th><span style="font-weight:bold">categoryWeight</span></th>
										...
										%>
											<tr>
												...
												<td><a href="<%=request.getContextPath()%>/category/deleteCategoryAction.jsp?categoryName=<%=c.getCategoryName()%>"><button type="button" class="btn btn-danger btn-sm">삭제</button></a></td>
											</tr>
										<%
											}
										%>
