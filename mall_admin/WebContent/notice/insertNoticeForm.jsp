        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <form class="form-horizontal" action="<%=request.getContextPath()%>/notice/insertNoticeAction.jsp" method="post">
                            <input type="hidden" name="managerId" value="<%=manager.getManagerId()%>">
                            <div class="card-body">
                                    <h4 class="card-title">Insert Notice</h4>

                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">noticeTitle</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="lname" name="noticeTitle" required="required" placeholder="noticeTitle">
                                        </div>
                                    </div>

									<div class="form-group row">
                                        <label for="cono1" class="col-sm-3 text-right control-label col-form-label">noticeContent</label>
                                        <div class="col-sm-9">
                                            <textarea class="form-control" rows="5" cols="80" name="noticeContent" required="required"></textarea>
                                        </div>
                                    </div>
                                </div>
