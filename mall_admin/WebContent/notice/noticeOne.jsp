            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">      
                            ...
                            <form class="form-horizontal">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <p class="col-sm-9 control-label col-form-label"><%=notice.getNoticeTitle()%></p>
                                        </div>
                                    </div>
                                    
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label"><span style="font-weight:bold">managerId</span></label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label"><span style="font-weight:bold">noticeContent</span></label>
                                        <div class="col-sm-9">
                                        	<pre class="col-sm-9 control-label col-form-label"><%=notice.getNoticeContent()%></pre>
                                            <p class="col-sm-9 control-label col-form-label"></p>
                                        </div>
                                    </div>
                                    
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label"><span style="font-weight:bold">noticeDate</span></label>
                                        <div class="col-sm-9">
                                            <p class="col-sm-9 control-label col-form-label"><%=notice.getNoticeDate().substring(0,11)%></p>
                                        </div>
                                    </div>
                                    
                                    	<a href="<%=request.getContextPath()%>/notice/noticeList.jsp"><button type="button" class="btn btn-success btn-sm">목록</button></a>
	                                   	<a href="<%=request.getContextPath()%>/notice/updateNoticeOneForm.jsp?noticeNo=<%=notice.getNoticeNo()%>"><button type="button" class="btn btn-warning btn-sm">수정</button></a>
										<a href="<%=request.getContextPath()%>/notice/deleteNoticeOneAction.jsp?noticeNo=<%=notice.getNoticeNo()%>"><button type="button" class="btn btn-danger btn-sm">공지사항 삭제</button></a>
                        ...
                        <div class="card">
                            <form class="form-horizontal" action="<%=request.getContextPath()%>/notice/insertCommentAction.jsp" method="post">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label"><span style="font-weight:bold">managerId</span></label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="fname" name="managerId" value="<%=manager.getManagerId()%>" readonly="readonly">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="cono1" class="col-sm-3 text-right control-label col-form-label"><span style="font-weight:bold">commentContent</span></label>
                                        <div class="col-sm-9">
							...
							%>
                                ...
                                <div class="d-flex flex-row comment-row m-t-0">
                                    ...
                                    <div class="comment-text w-100">
                                        <h6 class="font-medium"><%=c.getManagerId()%></h6>
                                        <span class="m-b-15 d-block"><%=c.getCommentContent()%></span>
                                        <div class="comment-footer">
                                            <span class="text-muted float-right"><%=c.getCommentDate().substring(0,10)%></span> 
                                            <a href="<%=request.getContextPath()%>/notice/deleteCommentAction.jsp?commentNo=<%=c.getCommentNo()%>&noticeNo=<%=noticeNo%>&managerId=<%=manager.getManagerId()%>">
