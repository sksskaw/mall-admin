            ...
            <div class="auth-box bg-dark border-top border-secondary">
                <div>
                    <div class="text-center p-t-20 p-b-20">
                        <span class="db"><img src="<%=request.getContextPath()%>/master/assets/images/logo.png" alt="logo" /></span><br><br>
                    </div>
                    <!-- Form -->
                    <form class="form-horizontal m-t-20" action="<%=request.getContextPath()%>/manager/insertManagerAction.jsp" method="post">
                        <div class="row p-b-30">
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-lg" placeholder="ID" aria-label="Username" aria-describedby="basic-addon1" name="managerId" required>
                                </div>
                                <!-- email -->
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                    ...
                                    <input type="text" class="form-control form-control-lg" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" name="managerName" required pattern="^[a-zA-Z가-힣]{2,100}$">
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="p-t-20"><br>
                                        ...
                                        <a href="<%=request.getContextPath()%>/login.jsp"><button class="btn btn-success btn-lg" type="button">Back</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
