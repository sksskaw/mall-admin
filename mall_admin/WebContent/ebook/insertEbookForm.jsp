        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <form class="form-horizontal" action="<%=request.getContextPath()%>/ebook/insertEbookAction.jsp" method="post">
                            <div class="card-body">
                                    <h4 class="card-title">Insert Ebook</h4>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">categoryName</label>
                                        <div class="col-sm-9">
                                        	<select class="select2 form-control custom-select" style="width: 100%; height:36px;" name="categoryName">
                                    ...
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">ebookISBN</label>
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" id="lname" name="ebookISBN" placeholder="ebookISBN" maxlength="11" required pattern="^\d{9}-\d{1}$">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">ebookTitle</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="lname" name="ebookTitle" placeholder="ebookTitle" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">ebookAuthor</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="lname" name="ebookAuthor" placeholder="ebookAuthor" required pattern="^[a-zA-Z가-힣\s]+$">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">ebookCompany</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="lname" name="ebookCompany" placeholder="ebookCompany" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">ebookPageCount</label>
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" id="lname" name="ebookPageCount" placeholder="ebookPageCount" required pattern="^[0-9]+$">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">ebookPrice</label>
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" id="lname" name="ebookPrice" placeholder="ebookPrice" required pattern="^[0-9]+$">
                                        </div>
                                    </div>
									<div class="form-group row">
                                        <label for="cono1" class="col-sm-3 text-right control-label col-form-label">ebookSummary</label>
                                        <div class="col-sm-9">
                                            <textarea class="form-control" rows="5" cols="80" name="ebookSummary" required></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="border-top">
                                    <div class="card-body">
                                        <button type="submit" class="btn btn-primary">ebook 추가</button>
