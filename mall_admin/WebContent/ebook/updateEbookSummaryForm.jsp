...
<%
	...
	System.out.println("ebookNo : "+ ebook.getEbookNo()); //디버깅
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <form class="form-horizontal" action="<%=request.getContextPath()%>/ebook/updateEbookSummaryAction.jsp?" method="post">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="fname" value="<%=ebook.getEbookTitle()%>" readonly="readonly">
                                        </div>
                                    </div>
